...
export class RepositoryService {
  ...
  getAllPortfolioProjects(): IPortfolioProject[] {
    return [
      new PortfolioProject('Resume.io', '2019', 'undraw_online_cv_qy9w.svg',
        ['Angular', 'HTML', 'SCSS', 'Bootstrap'],
        'Web based resume designed to automatically provide aesthetically pleasing printable layout for given data.',
        'https://github.com/kp-marczynski/resume-io'),
      new PortfolioProject('Ionic Songbook', '2019', 'undraw_listening_1u79.svg',
